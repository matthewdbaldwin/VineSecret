...
class ProductDetails extends Component {
    ...
    componentDidUpdate(prevProps) {
        const previousId = prevProps.match.params.product_id;
        const nextId = this.props.match.params.product_id;

        if (previousId !== nextId) {
            this.props.clearProductDetails();
            this.props.getProductDetails(nextId);
    ...
    render() {
            ...
            return (
                <div className="product-details-page not-found">
                    <div className="details-card info-card">
                        ...
                        <h2>We couldn’t find that release.</h2>
                        <p className="description">
                            It may be sold out or the link may be outdated. Browse current releases or contact the cellar team
                            for assistance.
                        </p>
        ...
        const highlightPills = [details.type, "Neutral French oak", "Native ferment", "Cold pack shipping"];

        const technicalNotes = [
            `Wine type: ${details.type}.`,
            ...
            <div className="product-details-page">
                <section className="product-details-hero">
                    ...
                    <div className="hero-image details-card image-card">
                        <img src={details.image.url} alt={`${details.name} bottle illustration`} />
                    </div>
                </section>
