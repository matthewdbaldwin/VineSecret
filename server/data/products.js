...
const products = [
    {
        ...
        description: 'Wine type: Chardonnay. Whole-cluster pressed and fermented in neutral French oak for nine months. Bright orchard fruit rides a saline backbone with chamomile and a lemon curd finish.',
        cost: 5200,
    },
    {
        ...
        description: 'Wine type: Pinot Noir. Destemmed berries cold soaked for 48 hours before a slow native ferment. Raspberry coulis, pomegranate, cedar shavings, and clove build across a supple palate with fine-grained tannins.',
        cost: 6800,
    },
    {
        ...
        description: 'Wine type: Cabernet Sauvignon. Aged 20 months in neutral barrique. Dense cassis and plum meet violets, pencil lead, and cocoa nib with a long finish framed by gravelly tannins.',
        cost: 9200,
    },
    {
        ...
        description: 'Wine type: Sauvignon Blanc. Pressed to stainless and held on fine lees for four months. Notes of yuzu, jasmine, and passion fruit orbit a nervy mineral core—perfect for chilled evenings on the coast.',
        cost: 3800,
    },
    {
        ...
        description: 'Wine type: GSM blend. Grenache leads with juicy red fruit while Syrah and Mourvèdre add spice, olive tapenade, and savory herbs. Fermented in concrete and raised in large-format casks for lift.',
        cost: 5600,
    },
    {
        ...
        description: 'Wine type: Syrah. Co-fermented with a whisper of Viognier for lifted florals. Smoked meat, cracked pepper, and blue fruit ride a savory mid-palate with a fresh, coastal finish.',
        cost: 6100,
    },
    {
        ...
        description: 'Wine type: Rosé. Direct-press Pinot Noir fermented cool in stainless. Crisp acidity frames watermelon rind, citrus zest, and alpine herbs—built for picnics and porch sipping.',
        cost: 3200,
    },
    {
